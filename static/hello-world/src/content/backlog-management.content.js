...
const en = {
  ...
  assistant: {
    ...
    quickActions: [
      { id: "sprint_summary", label: "Share sprint summary", icon: "activity" },
      { id: "vendor_blockers", label: "Send blockers to vendor", icon: "alert-circle" },
      { id: "unassigned_mail", label: "Mail unassigned issues", icon: "users" },
      { id: "weekly_client", label: "Weekly client status", icon: "calendar" },
    ],
